...
const DivisionCreatingPage = () => {
  ...
  const divisionHandler = async (data) => {
    try {
      ...
      if (token) {
        const response = await DivisionSvc.createDivision(token, data);
  ...
  const basicForm = (
    ...
    >
      <div className="form-container">
        <div className="logo-container">Create A New Division</div>
...
export default DivisionCreatingPage;
